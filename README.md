...
- **Relic Shop** — buy and equip up to three of ten run-long trinkets for roughly $75–$120 each. Relics can improve luck, pack prices, card values, PSA grading, fake-pack protection, box discounts, Binder growth, quota time, or battle rewards. Destroying a relic frees its slot permanently with no refund; relics are free in Sandbox.
