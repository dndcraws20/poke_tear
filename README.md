...
Single-file pack-opening game with a set picker for Mega Evolution — Chaos Rising (ME04), Pitch Black (ME05), Phantasmal Flames (ME02), and Scarlet & Violet — Destined Rivals (SV10).
...
```
scp index.html pack.jpg chaos-rising-pack.png destined-rivals-pack.jpg phantasmal-flames-pack.png root@<vps>:/var/www/pack-opener/
```
