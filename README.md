...
Single-file pack-opening game with a set picker for Mega Evolution — Chaos Rising (ME04), Pitch Black (ME05), and Scarlet & Violet — Destined Rivals (SV10).
...
- **Set switching** — swap between Pitch Black ($4.99), Chaos Rising ($9.99), and Destined Rivals ($15.00) during the same run without losing your bankroll, upgrades, quota, or stats. Chaos Rising card values receive a 20% game-value boost and Destined Rivals receives a 30% boost.
...
```
scp index.html pack.jpg chaos-rising-pack.png destined-rivals-pack.jpg root@<vps>:/var/www/pack-opener/
```
