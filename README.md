...
- **Rotating Relic Shop** — five different relic offers appear and reroll every 30 seconds; equip up to three of ten run-long trinkets. Offer rarities are weighted Common 50%, Rare 20%, Legendary 10%, and Cursed 20%, making Cursed relics exactly as likely as Rare ones. Cursed relics grant a large benefit with a dangerous downside. Destroying a relic frees its slot permanently with no refund; relics are free in Sandbox.
