...
- **Persistent card binder** — keep up to eight cards across runs, view them in a large two-column gallery, tap any card for a full-size inspection, grade cards with PSA inside the binder, or sell them into an active money-mode run. The one-minute value change remains intentionally hidden.
