...
- **Twenty-six upgrades** — alongside the pack, PSA, quota, Binder, and battle upgrades, four new upgrades improve the minimum AI auction offers, protect the mandatory fifth offer, reduce counterfeit-pack risk, and shorten Kiss the Pack's cooldown. Every upgrade is free in Sandbox and lasts for the entire run.
