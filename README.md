...
- **Three-card Binder battles** — build a permanent deck from three Binder cards, train them through ten levels, and fight automatic HP-and-damage battles where every card uses its strongest attack. Single trainers and best-of-five tournaments have Easy, Medium, Hard, and brutal Impossible difficulties with escalating cash prizes. Knocked-out cards always remain in the Binder.
