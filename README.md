...
- **Binder card trading** — request an offer for any Binder card and compare both cards using only their artwork, name, and set; neither price is shown. The offered card’s normal value is selected from 50% below to 50% above the card being traded, but every offer secretly has a 10% chance of being fake and worth $0. Accepting replaces the original card and removes it from the battle deck; declining keeps the original.
