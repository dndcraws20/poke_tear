...
- **Three random single packs** — Scrappy costs $5 before store modifiers, selects Pitch Black, Chaos Rising, or Sword & Shield, has 0.65× chase luck and eight percentage points of extra fake risk. Solid costs $13, selects Chaos Rising, Sword & Shield, Destined Rivals, or Phantasmal Flames, has 1.25× luck and three extra fake-risk points. Premium costs $30, selects Destined Rivals, Phantasmal Flames, 151, or Sun & Moon, has 2.25× luck and no added fake risk. The set appears when opened; the selected store's prices, perks, and risk still apply. The set switch keeps the same save.
...
- **Mystery six-pack boxes** — buy a sealed box at a discount relative to six Chaos Rising packs from the chosen store. The game picks and saves its hidden set when purchased: Chaos Rising (50%), Sword & Shield (25%), Destined Rivals (15%), Phantasmal Flames (8%), or 151 (2%). Reveal later to add six packs of that set to the same saved run. Store fake risk and perks are locked to the purchase store and applied when each pack opens. Box discount upgrades and relics also apply to its price.
