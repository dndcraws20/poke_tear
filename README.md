...
- **Live Auction House** — three individual cards go up for auction every 30 seconds. Place bids against computer collectors; bid money is held in escrow, refunded when outbid, and winning cards are delivered to the Binder. Open Binder space is required before bidding.
