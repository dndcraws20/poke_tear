...
<body>
  ...
  <script>
    ...
    function newState(mode) {
      return { mode, set: selectedSet, bank: START_BANK, packs: 0, spent: 0, earned: 0, peak: START_BANK, best: null, up: { luck: 0, bulk: 0, rev: 0, whole: 0, mint: 0, shine: 0, bonus: 0 }, last: null,
    ...
    function start(mode, resume) {
      ...
      S.up = { luck: 0, bulk: 0, rev: 0, whole: 0, mint: 0, shine: 0, bonus: 0, ...(S.up || {}) };
      ensureQuota();
      show('game');
      $('cards').innerHTML = '';
